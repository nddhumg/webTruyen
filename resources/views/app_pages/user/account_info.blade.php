...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <ul class="flex text-gray-500 text-sm mb-6 space-x-2">
            <li><a href="https://www.toptruyentv11.com" class="hover:text-blue-600">Trang chủ</a> /</li>
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="md:w-1/4 w-full bg-white rounded-lg shadow p-4">
                <div class="flex flex-col items-center mb-4">
                    <img src="https://www.toptruyentv11.com/images/user.png" alt=""
                ...
                <nav class="space-y-2">
                    ...
                    <a href="https://www.toptruyentv11.com/user/comment"
                        class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100">
                ...
                <form action="{{ route('users.update') }}" method="post" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <img src="https://www.toptruyentv11.com/images/user.png" alt=""
                                class="w-32 h-32 rounded-full object-cover mb-2" id="avatarSelect">
                            <input type="file" name="avatar" id="imgInput" accept="image/*"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const avatarPreview = document.getElementById('avatarSelect');
