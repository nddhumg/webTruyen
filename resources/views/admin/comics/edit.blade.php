...
@section('vite_js')
    @vite('resources/js/admin/truyen/edit.js')
@endsection
    ...
    <div class=" p-8 w-full ">
        ...
        <form action="{{ route('admin.comic.update', $comic->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input value='{{ $comic->title }}' type="text" id="title" name="title" placeholder="Nhập tên truyện"
            ...
            <div>
                ...
                <input  value='{{ $comic->author }}'  type="text" id="author" name="author" placeholder="Nhập tên tác giả"
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <textarea  value='{{ $comic->description }}'  id="description" name="description" rows="4" placeholder="Nhập mô tả truyện"
